...
public class MenuModel {
	...
	private List<List<String>> menuItems = Arrays.asList(Arrays.asList("아메리카노", "라떼", "모카", "에스프레소"),
	...
	private List<List<Integer>> menuPrices = Arrays.asList(Arrays.asList(2500, 3000, 3500, 2700),
